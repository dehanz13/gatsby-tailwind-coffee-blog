      ...
      >
        <div className="grid lg:grid-cols-2 xs:grid-cols-1 gap-10 ">
          <div className="max-w-lg rounded overflow-hidden shadow-lg  bg-gray-100">
            ...
            <div className="lg:px-6 lg:pt-4 xs:pb-2 xs:pl-6 xs:pt-0">
          ...
          <div className="max-w-lg rounded overflow-hidden shadow-lg bg-gray-100">
            <StaticImage
              ...
              formats={["auto", "webp", "avif"]}
            />
            <div className="lg:py-20 lg:px-10 xs:py-10 xs:px-4 justify-center items-center bg-yellow-100">
              <div className="">
                <h1 className="lg:font-bold lg:text-2xl xs:text-lg xs:font-bold mb-1">
                  Brew Coffee Like A Badass Barista!
                </h1>
                <h1 className="lg:font-bold lg:text-xl xs:text-xs xs:font-semibold">
                  Get top SECRET tips and tricks for brewing the PERFECT cup of
                  coffee for FREE
                </h1>
              </div>
              <div className="relative grid grid-rows-2 gap-2 lg:w-full xs:w-3/2 items-stretch">
                <input
                  type="text"
